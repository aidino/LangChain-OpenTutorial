...
def encode_pdf(path, collection_name, embedding_model='bge-m3:latest' ,chunk_size=1000, chunk_overlap=200):
    """
    Mã hóa PDF document thành một vector store
...
def encode_from_string(content, collection_name, embedding_model='bge-m3:latest', chunk_size=1000, chunk_overlap=200):
    """
